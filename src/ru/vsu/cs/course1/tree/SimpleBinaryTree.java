...
public class SimpleBinaryTree<T> implements BinaryTree<T> {
    ...
    public void rebuildTree() {
        SimpleTreeNode transpose = root.left;

        SimpleTreeNode toInsert = this.getMaxRight();

        toInsert.right = transpose;
        root.left = null;
    }

    private SimpleTreeNode getMaxRight() {
        SimpleTreeNode current = root;
